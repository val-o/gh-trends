...
import { EmphasizeColor, TypographyColor } from "./theme";

export type IconProps = {
  color?: TypographyColor | EmphasizeColor;
  className?: string;
};

const createSvgIcon = (path: React.ReactElement) => {
  const Component: React.VFC<IconProps> = ({ color, className }) => {
    const theme = useTheme() as Jss.Theme;
    return (
      <svg
        aria-hidden="true"
        height="16"
...
export const ForkIcon = createSvgIcon(
  <path
    fillRule="evenodd"
    fill="currentColor"
...
export const PopularIcon = createSvgIcon(
  <path
    fillRule="evenodd"
    fill="currentColor"
